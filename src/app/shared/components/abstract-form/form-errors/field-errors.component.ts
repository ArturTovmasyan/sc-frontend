...
@Component({
  ...
  template: `
    <ng-container *ngFor="let e of errors" [ngSwitch]="e.error">
      ...
      <span *ngSwitchCase="'earlier_than'">This value must be earlier than {{ e.params.value|date:'MM/dd/yyyy HH:mm:ss':'UTC' }}.</span>
      <span *ngSwitchCase="'later_than'">This value must be later than {{ e.params.value|date:'MM/dd/yyyy HH:mm:ss':'UTC' }}.</span>
