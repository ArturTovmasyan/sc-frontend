...
export class ListComponent extends GridComponent<FacilityDiningRoom, FacilityDiningRoomService> {
  constructor(service$: FacilityDiningRoomService, title$: TitleService, modal$: NzModalService) {
