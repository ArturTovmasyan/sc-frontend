...
import {FormComponent as LeadFormComponent} from '../../lead/form/form.component';
import {FormComponent as ReferralFormComponent} from '../form/form.component';
      ...
      case 'param_id':
        this.$subscriptions[key] = this.route$.paramMap.subscribe(route_params => {
          if (route_params.has('id')) {
            this.subscribe('get_referral', {referral_id: route_params.get('id')});
          }
        });
        break;
      case 'get_referral':
        this.$subscriptions[key] = this.referral$.get(params.referral_id).pipe(first()).subscribe(res => {
          if (res) {
            ...
            this.subscribe('get_lead', {lead_id: res.lead.id});
          }
        });
        break;
      case 'get_lead':
          ...
          onClick: () => {
            ...
            submit(form_data).subscribe(
              res => {
                ...
                this.subscribe('get_referral', {referral_id: this.referral.id});
